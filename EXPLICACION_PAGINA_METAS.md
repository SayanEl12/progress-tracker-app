...
1. **Diálogo de Creación**: Formulario para crear nuevas metas

1. **Grid de Metas**: Muestra todas las metas en tarjetas

1. **Tarjeta de Meta**: Cada meta es clickeable y tiene botón de eliminar
...
1. ✅ **Interfaz intuitiva**: Diálogos modales para crear

1. ✅ **Actualizaciones en tiempo real**: La lista se recarga automáticamente

1. ✅ **Manejo de errores**: Estados de carga y error

1. ✅ **Navegación**: Puedes hacer clic en una meta para ver detalles

1. ✅ **Pesos configurables**: `weightAI` y `weightTrackables` personalizables
...
1. Agregar botón de editar meta

1. Mostrar barra de progreso en tarjetas

### Prioridad Media:

1. Indicadores visuales de estado (activa/próxima/completada)

1. Pesos configurables en la UI

1. Mostrar fechas en formato legible

### Prioridad Baja:

1. Animaciones al crear/eliminar

1. Búsqueda y filtrado de metas

1. Exportar metas a CSV
